const Decks= [
    ...
    {id:2, question:'O React é', answer:'Uma biblioteca JavaScript para construção de interfaces'},
    {id:3, question:'Componentes devem iniciar com', answer:'letra maiúscula'},
...
//adicionar variaveis de icone, cor?, aberto ou fechado?
//funçaõ que fecha todos
//e quando clica no botão embaixo (for each para ver qual pergunta ta abeta), 
